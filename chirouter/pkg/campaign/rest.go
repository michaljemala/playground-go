...
func (h *restHandler) List(rw http.ResponseWriter, r *http.Request) {
	fmt.Fprintf(rw, "%s %s -> campaign.restHandler.List", r.Method, r.RequestURI)
}

func (h *restHandler) Get(rw http.ResponseWriter, r *http.Request) {
	fmt.Fprintf(rw, "%s %s -> campaign.restHandler.Get(%s)", r.Method, r.RequestURI, chi.URLParam(r, "id"))
}

func (h *restHandler) Create(rw http.ResponseWriter, r *http.Request) {
	fmt.Fprintf(rw, "%s %s -> campaign.restHandler.Create", r.Method, r.RequestURI)
}

func (h *restHandler) Update(rw http.ResponseWriter, r *http.Request) {
	fmt.Fprintf(rw, "%s %s -> campaign.restHandler.Update(%s)", r.Method, r.RequestURI, chi.URLParam(r, "id"))
}

func (h *restHandler) Delete(rw http.ResponseWriter, r *http.Request) {
	fmt.Fprintf(rw, "%s %s -> campaign.restHandler.Delete(%s)", r.Method, r.RequestURI, chi.URLParam(r, "id"))
}
